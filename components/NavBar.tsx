  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line/60 bg-paper/80 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        ...
        {/* روابط النافبار — تظهر فقط على الشاشات المتوسطة وما فوق */}
        ...
        {/* زر الوضع الليلي — يظهر دائمًا */}
        <div className="flex flex-shrink-0 items-center border-r border-line/60 pr-2 md:border-r-0 md:pr-0">
          <ThemeToggle />
        </div>
      </nav>
    </header>
